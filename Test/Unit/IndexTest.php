...
namespace OlapicIntegration\SampleNewPage\Test\Unit\Controller\Index;
...
class IndexTest extends \PHPUnit_Framework_TestCase
{
    public function testExecute()
    {
        ...
        $model = $objectManager->getObject('OlapicIntegration\SampleNewPage\Controller\Index\Index',
